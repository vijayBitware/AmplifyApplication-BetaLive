...
class ChipsAdapter
    ...
    ChipsAdapter(ChipDataSource dataSource,
                 ...
                 ChipOptions options, CallBackInt callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return viewType == CHIP
                ? new ChipHolder(new ChipView(parent.getContext(),callback))
    ...
    private class ChipHolder extends RecyclerView.ViewHolder implements
        ...
        public void onChipDeleted(ChipView v) {
            ...
            if (position > -1){
                ...
                Utils.TAGLIST.remove(position);

//                System.out.println("*******dellll******"+mDataSource.getOriginalChips().get(position).toString());
            }
        }
    }
}