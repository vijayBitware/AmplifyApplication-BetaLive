...
import mabbas007.tagsedittext.utils.AppApplication;
...
public class TagsEditText extends AutoCompleteTextView {
    ...
    private final TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
           /* if (ResourceUtils.tagAddCount == 10) {
                ...
                //ResourceUtils.showSnackBarPink(AppApplication.getContext(), findViewById(android.R.id.content),  "You have reached maximum limit for tags");
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            System.out.println("********on text*******" + ResourceUtils.tagAddCount);
    ...
    private void setTags() {
        System.out.println("***********" + ResourceUtils.tagAddCount);
        if (ResourceUtils.tagAddCount < 10) {
            ...
            if (str.endsWith(SPACE) || (!mIsSpacesAllowedInTags && str.endsWith(mSeparator)) && !isDeleting) {
                if (ResourceUtils.tagAddCount <= 10) {
                    buildTags(str);
                }
            }
    ...
    private void updateTags(String newString) {
        ...
        if (!TextUtils.isEmpty(source) && !source.equals(SPACE)) {
            boolean isSpan = source.endsWith(SPACE) ||
