...
/**
 * Created by bitware on 22/2/18.
 */

public class APIRequestNew extends AppCompatActivity {
    ...
    public APIRequestNew(Context context, JSONObject jsonObject, String url,ResponseHandler responseHandler, int api, String methodName) {
