...
import com.amplify.view.Activity.SwipeNewSecondActivity;
...
public class GridViewAdapterSecond extends ArrayAdapter<UserDatum> implements APIRequestNew.ResponseHandler {
    ...
    public GridViewAdapterSecond(Context context, int layoutResource, String append, List<UserDatum> imgURLs) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Activity activity = (Activity) mContext;
                Intent intent = new Intent(mContext, SwipeNewSecondActivity.class);
                activity.startActivity(intent);
                activity.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
